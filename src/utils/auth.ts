...
export default {
    ...
    isAuthGuild(id: string): boolean {
        return [
            ...
            "1014503329289732097", //'喵喵 的伺服器
            "934057218305818675",  // 魚魚家
            '981737244236865577', // Infinite™
            // '1007668694765293568' //舊釣魚
            "856793573194465300", // 呵呵YA
            "986575688159084545", // 血眼龍
            "937994775775309827", // 第五搞事
            "1032880609883856937", // 噁男
            "997172475999830146", // 帥哥
            "1042333554085998662",
            "1061291528401731584", // 貓手管理
            "1037654071450013707", // 光隙解語官方
            "1045369047996432515", // 光隙解語私人
            "1112697650182094870", // 月之國
        ].includes(id);
    },
